...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_lab_stats` (IN `p_lab` VARCHAR(50))   
BEGIN
    SELECT 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_student_stats` (IN `p_id_number` VARCHAR(20))   
BEGIN
    SELECT 
        COUNT(*) as total_sitins,
        AVG(TIMESTAMPDIFF(MINUTE, login_time, logout_time)) as avg_duration,
...
CREATE TABLE `computers` (
  ...
  `status` enum('available','in-use','disabled') DEFAULT 'available'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `computers` (`id`, `lab`, `computer_number`, `status`) VALUES
(1, '524', 1, 'available'),
(2, '524', 2, 'available'),
(3, '524', 3, 'available'),
(4, '524', 4, 'available'),
...
INSERT INTO `feedback` (`id`, `sit_in_id`, `student_id`, `admin_id`, `message`, `created_at`, `status`) VALUES
(1, 30, '1000', 'admin1', 'Great session!', '2025-05-06 10:00:00', 'resolved'),
(2, 31, '2000', 'admin2', 'Need more resources.', '2025-05-06 11:00:00', 'pending'),
(3, 32, '3000', 'admin3', 'Excellent support.', '2025-05-06 12:00:00', 'closed');
...
(1000, 'Santos', 'Maria', '123', 'BSBA', '2', '1000@gmail.com', 'msantos1001', '123', 11, 3, 0, 'pngfind.com-weights-png-1091286.png'),
(2000, 'Reyes', 'Maria', 'Dela', 'BSCS', '1', '2000@gmail.com', 'jreyes1002', '123', 28, 2, 1, 'default.png'),
(2200, 'M Singco', 'Nathaniel', 'Ron', 'BSIT', '2', 'singcoaricel061@gmail.com', 'naromasi2', '123', 15, 0, 0, 'default.png'),
(3000, 'Lim', 'Anna', 'Tan', 'BSIT', '3', '3000@gmail.com', 'alim1003', '123', 27, 0, 3, '4OTdtjem_F_thumb_1200x630.jpg'),
(4000, 'Cruz', 'Pedro', 'Reyes', 'BSME', '2', '4000@gmail.com', 'pcruz1004', '123', 14, 0, 0, 'default.png'),
(5000, ' Dela Cruz', 'Juan', 'Santos', 'BSIT', '2', '5000@gmail.com', 'juandc', '123', 29, 1, 0, 'default.png'),
(6000, 'Reyes', 'Maria', 'Lourdes', 'BSECE', '3', '6000@example.com', 'mariareyes', '123', 12, 2, 1, 'default.png'),
...
(11000, 'Specter', 'Mark', 'y', 'BSME', '2', 'mark@gmail.com', 'mark123', '123', 14, 1, 0, 'default.png'),
...
(1, '1000', 10, 'Participation in event', 'admin1', '2025-05-06 10:00:00'),
(2, '2000', 15, 'Top performer', 'admin2', '2025-05-06 11:00:00'),
(3, '3000', 5, 'Feedback submission', 'admin3', '2025-05-06 12:00:00');
...
INSERT INTO `reservations` (`id`, `student_id`, `lab`, `purpose`, `reservation_date`, `start_time`, `end_time`, `status`, `created_at`) VALUES
(1, '1000', '524', 'Group Study', '2025-05-07', '10:00:00', '12:00:00', 'approved', '2025-05-06 09:00:00'),
(2, '2000', '526', 'Project Work', '2025-05-07', '13:00:00', '15:00:00', 'pending', '2025-05-06 10:00:00'),
(3, '3000', '528', 'Research', '2025-05-07', '16:00:00', '18:00:00', 'rejected', '2025-05-06 11:00:00');
...
(41, '2000', 'Java Programming', '526', 'inactive', '2025-04-26 18:13:42'),
(42, '3000', 'Python', '528', 'inactive', '2025-04-26 18:13:51'),
(43, '1000', 'Python', '528', 'inactive', '2025-04-26 18:14:24'),
(44, '5000', 'C Programming', '526', 'inactive', '2025-04-29 13:54:22'),
(45, '6000', 'IT Trend', '526', 'inactive', '2025-04-29 15:50:38'),
(46, '3000', 'C#', '524', 'inactive', '2025-05-03 12:10:54'),
(47, '3000', 'C#', '524', 'inactive', '2025-05-03 12:11:19'),
(48, '5000', '', '', 'inactive', '2025-05-03 12:22:14'),
(49, '9000', 'Computer Application', '530', 'active', '2025-05-03 14:31:39'),
(50, '3000', 'Java Programming', '524', 'active', '2025-05-03 15:12:50'),
(51, '10000', 'Computer Application', '524', 'active', '2025-05-03 15:12:58'),
(52, '11000', 'Technopreneurship', '526', 'active', '2025-05-03 15:13:23'),
(53, '6000', 'Project Management', '526', 'inactive', '2025-05-03 15:23:47'),
(54, '1000', 'C Programming', '524', 'active', '2025-05-04 07:08:23');
...
ALTER TABLE `computers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_computer` (`lab`,`computer_number`);
